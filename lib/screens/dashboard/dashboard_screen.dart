...
class DashboardScreen extends StatefulWidget {
  ...
  const DashboardScreen({super.key, this.activeListenable});
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    if (activeListenable == null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) _loadAll();
      });
    } else {
      activeListenable.addListener(_handleActiveChanged);
      if (activeListenable.value) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (mounted) _loadAll();
        });
      }
  ...
  void _handleActiveChanged() {
    if (widget.activeListenable?.value == true && mounted) {
      _loadAll();
    }
  }
